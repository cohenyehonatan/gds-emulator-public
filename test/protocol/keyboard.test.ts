...
describe('keyboard mapping', () => {
  it('maps physical-key aliases to Sabre special characters', () => {
  ...
  it('is idempotent on real glyphs and leaves ordinary entries alone', () => {
  ...
  it('splits on the end-item separator', () => {
